...
if(isset($_POST['submit']))
{
	...
	else
	{
		...
		if(mysqli_query($con, $query))
		{
			...
			$f .= "$id.";
			$f .= "$imagefiletype";
			$newfile_name = $target_dir.strtolower("$f");

				if((filesize($_FILES['userfile']["tmp_name"])/1024) > 1024)
				{
					$submit_error = "File is too big. Cannot be uploaded";
					echo filesize($_FILES['userfile']["tmp_name"])/1024;
					echo "<script type='application/javascript'>alert('File Size is Too Big. Please try again');window.location = 'register.php';</script>";

				}
				else
				{
					if(move_uploaded_file($_FILES['userfile']["tmp_name"], $newfile_name))
					{
						$submit_error = "Profile Picture Updated successfully";
					}
					else {
						echo "<script type='application/javascript'>alert('Unable To Upload Picture')</script>";
					}
				}

			echo "<script type='application/javascript'>alert('Registered Succesfully');window.location = 'login.php';</script>";
		}
		else
		{
                	...
                	<div class="panel-body">
                        ...
                        <div class="row">
                        	<div class="col-lg-6 col-md-6">
                                ...
                                <input type="text" class="form-control" name="r_flat" placeholder="Flat/Door/Block No:" required><span class="error">  <?php  echo $r_flat_err?> </span>
                             </div>
                             <div class="col-lg-6 col-md-6">
                        ...
                        <div class="row">
                        	<div class="col-lg-6 col-md-6">
                             ...
                             <div class="col-lg-6 col-md-6">
                                ...
                                <input type="number" class="form-control" name="r_pin" maxlength="6" minlength="6"  value="<?php if(isset($_SESSION['r_pin'])){ echo $_SESSION['r_pin'];}?>" placeholder="PIN" required><span class="error">  <?php  echo $r_pin_err?> </span>
                             </div>
                        </div><!-- row -->
                        ...
                        <div class="row">
                        	<div class="col-lg-6 col-md-6">
                             ...
                             <div class="col-lg-6 col-md-6">
                                ...
                                <input type="text" class="form-control" name="r_city" placeholder="City" required>
                             </div>
                        </div><!-- row -->
                        ...
                        <div class="row">
                        	<div class="col-lg-6 col-md-6">
                                ...
                                <input type="text" class="form-control" name="r_post_office" placeholder="Post Office" required>
                             </div>
                             <div class="col-lg-6 col-md-6">
                             	<label class="label control-label">District</label>
                                <input type="text" class="form-control" name="r_dist" placeholder="District" required>
                             </div>
                        </div><!-- row -->
                        ...
                        <div class="row">
                        	<div class="col-lg-6 col-md-6">
                            	<label class="label control-label">Flat/Door/Block No:</label>
                                <input type="text" class="form-control" name="p_flat" placeholder="Flat/Door/Block No:" required><span class="error">  <?php  echo $p_flat_err?> </span>
                             </div>
                             <div class="col-lg-6 col-md-6">
                             	<label class="label control-label">Street/Lane (optional)</label>
                        ...
                        <div class="row">
                        	<div class="col-lg-6 col-md-6">
                             ...
                             <div class="col-lg-6 col-md-6">
                             	<label class="label control-label">PIN</label>
                                <input type="number" class="form-control" name="p_pin" maxlength="6" minlength="6" value="<?php if(isset($_SESSION['p_pin'])){ echo $_SESSION['p_pin'];}?>" placeholder="PIN" required><span class="error">  <?php  echo $p_pin_err?> </span>
                             </div>
                        </div><!-- row -->
                        ...
                        <div class="row">
                        	<div class="col-lg-6 col-md-6">
                            	<label class="label control-label">Post Office</label>
                                <input type="text" class="form-control" name="p_post_office" placeholder="Post Office" required>
                             </div>
                             <div class="col-lg-6 col-md-6">
                             	<label class="label control-label">District</label>
                                <input type="text" class="form-control" name="p_dist" placeholder="District" required>
                             </div>
                        </div><!-- row -->
											...
											<div class="row">
												<div class="upload-btn-wrapper">
													<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
														...
														<button class="btn1">Upload Profile Picture</button>
														<input type="file" name="userfile" id="PROFILE_PICTURE" onChange="$('#input_image').attr('src',window.URL.createObjectURL(this.files[0]));$('#upload_file_name').html(this.files[0].name);$('#input_image').attr('style','display:block');" required>
													</div>
																		...
																		<div class="profile_img">
																			<div id="crop-avatar">
																				<!-- Current avatar -->
																					...
																					<img class="img-responsive img-thumbnail avatar-view" id="input_image" style="width:200px; max-width:200px; max-height:100px; cursor:pointer; display:none" src="#">
